...
/**
 * Represents all data access operations involving [Notification] & [SessionNotification] records using the DSL approach.
 */
internal class DSLNotificationRepository : NotificationRepository {
